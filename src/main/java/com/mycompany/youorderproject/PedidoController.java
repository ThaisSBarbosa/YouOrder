...
public class PedidoController implements Initializable {
    ...
    private void ConfirmarPedido() throws Exception {
        SalvaPedido();
    }

    private void SalvaPedido() throws Exception {
        ...
        SalvaItensPedido(novoPedido);
    }

    private void SalvaItensPedido(Pedido novoPedido) throws PersistenciaException, IOException {
    ...
    private void ExibeConfirmacao() throws IOException{
        try {
